...
public class AnalizadorSintactico {
    public static void main(String[] args) throws IOException {
        Reader lector = new BufferedReader(new FileReader("src/act_8_sintactico/pruebaSintactico.txt"));
        //Reader lector = new BufferedReader(new FileReader("src/act_8_sintactico/pruebaSintactico1.txt"));
        //Reader lector = new BufferedReader(new FileReader("src/act_8_sintactico/pruebaSintactico2.txt"));
